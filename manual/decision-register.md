...
| 0130 | Principál určuje záměr a drží publikační rozhodnutí, ale nemusí být architekt; Worker Agent nese odbornou odpovědnost za Lazurio-konformní návrh každé source změny. Povinný `architecture-shaping` skill odděluje záměr od mechanismu, preferuje jednu autoritu, nativní best practices, konvergenci a důkaz, škáluje podle rizika a není závislý na konkrétním reviewerovi nebo modelu. |
